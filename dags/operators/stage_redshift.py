...
class StageToRedshiftOperator(BaseOperator):
    ...
    sql = """
        ...
        REGION AS '{region}'
        FORMAT AS JSON '{s3_json_format_path}'
        TIMEFORMAT AS 'auto';
    """
    ...
    def __init__(self,
        ...
        self.s3 = s3
        self.region = region
        self.s3_json_format_path = s3_json_format_path
    ...
    def execute(self, context):
        ...
        # s3_json_format_path = "s3://{}/{}".format(self.s3["bucket_name"], "log_json_path.json")
        ...
        """.format(
            ...
            region = self.region,
            s3_json_format_path = self.s3_json_format_path,

        ))

        self.log.info("Copying data from {} to Redshift is finished".format(self.s3_json_format_path))